...
class Student {
    ...
    @Override
    public boolean equals(final Object other) { //This method is
        //to check if two students names are equal or not
